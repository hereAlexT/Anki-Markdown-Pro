...
const manifest = await Bun.file("markdown_pro/manifest.json").json();
...
await Bun.write("markdown_pro/manifest.json", JSON.stringify(manifest, null, 2) + "\n");

await $`git add package.json markdown_pro/manifest.json`;
