"""Settings dialog for Markdown Pro syntax highlighting configuration."""
...
REPO_URL = "https://github.com/hereAlexTeng/markdown-pro"
...
def debug_report() -> str:
    ...
    lines = [
        "Markdown Pro debug info",
        f"markdown_pro: {ADDON_VERSION}",
        f"anki: {anki_ver()}",
...
class ShikiSettingsDialog(QDialog):
    ...
    def section(self, title: str) -> tuple[QFrame, QVBoxLayout]:
        ...
        box = QFrame()
        box.setProperty("mdproSection", True)
        layout = QVBoxLayout(box)
        layout.setContentsMargins(14, 10, 14, 14)
        layout.setSpacing(10)
        label = QLabel(title)
        label.setProperty("mdproTitle", True)
    ...
    def setup_ui(self):
        ...
        meta = QHBoxLayout()
        version = QLabel(f"Markdown Pro {ADDON_VERSION} · Shiki {SHIKI_VERSION}")
    ...
    def export_debug(self):
        ...
        QMessageBox.information(self, "Markdown Pro", "Debug info copied to clipboard.")
    ...
    def apply_config(self):
        ...
        try:
            ...
            from . import ensure_all_notetypes
